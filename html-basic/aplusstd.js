...
!(function (t) {
        ...
        r = function (n, o) {
          try {
            var a = Math.floor(268435456 * Math.random()).toString(16),
              r = t.location || {},
              i = [
                'page=' + encodeURIComponent(r.href),
                'info=' + encodeURIComponent(n.message),
                'stack=' + encodeURIComponent(n && n.stack ? n.stack : ''),
                'filename=aplus_core',
                'method=' + o,
                'cache=' + a,
              ].join('&'),
  ...
  function (t, e, n) {
    ...
    (e.APLUS_ENV = 'production'),
      ...
      (e.plugins_pv = n(35).plugins_pv),
      (e.plugins_prepv = n(65).plugins_prepv),
      (e.context_hjlj = n(66)),
      (e.plugins_hjlj = n(68).plugins_hjlj),
      (e.beforeUnload = n(78)),
      (e.initLoad = n(83)),
      (e.spmException = n(87)),
      (e.goldlog_path = n(88)),
              ...
              if (
                ...
                if (2 === a || 4 === a) {
                  ...
                  r
                    ...
                    : (n.setLsTag(0), i.setLsCna(l.LS_CNA_KEY, n.today, e));
                }
                p();
              }
            }),
  ...
  function (t, e, n) {
    ...
    e.plugins_pv = [
      ...
      { name: 'can_to_sendpv', enable: !0, path: n(60) },
    ...
    t.exports = {
      ...
      getBasicParams: function () {
        ...
        var p = [
          ...
          f = /Safari/.test(g) && !/Chrome/.test(g);
        f && p.push(['_p_url', location.href]);
        var d = this.cookie_data || {},
          _ = this.options.context || {},
          h = _.etag || {},
          m = h.cna || d.cna || s.getCookie('cna');
        m && p.push([o.mkPlainKey(), 'cna=' + m]),
          d.tracknick && p.push([o.mkPlainKey(), 'nick=' + d.tracknick]);
        var v = n.spm_url || '';
        return (
          o.ifAdd(p, [
    ...
    t.exports = function () {
      return {
        ...
        getToUtData: function (t) {
          ...
          return (
            T && (v['utparam-cnt'] = JSON.stringify(T)),
            (v._is_g2u_ = c ? 1 : 2),
            v
          );
        },
  ...
  function (t, e, n) {
    ...
    e.plugins_hjlj = [
      ...
      { name: 'where_to_sendlog_ut', enable: !0, path: n(39) },
      { name: 'is_single', enable: !0, path: n(41) },
      { name: 'what_to_hjlj_exinfo', enable: !0, path: n(69) },
      { name: 'what_to_pvhash', enable: !0, path: n(45) },
      {
        name: 'what_to_hjlj',
        enable: !0,
    ...
    t.exports = function () {
      return {
        init: function (t) {
          ...
          this.isSafari = /Safari/.test(e) && !/Chrome/.test(e);
        },
        getParams: function () {
          var t = this.options.context || {},
            e = t.userdata || {},
          ...
          this.isSafari && (h._p_url = location.href),
            e['spm-cnt'] && (h['spm-cnt'] = e['spm-cnt']),
            e['spm-pre'] && (h['spm-pre'] = e['spm-pre']);
          try {
            var m = o.getExParams(a),
              v = a.param2obj(m).uidaplus;
            v && (h._gr_uid_ = v);
          } catch (t) {}
          return h;
        },
  ...
  function (t, e, n) {
    ...
    function o() {
      var t = new Date().getTime(),
        ...
        _ = function () {
          Math.random() < 0.01 && r.addScript(l),
  ...
  function (t, e, n) {
    ...
    var u = window,
      ...
      C = [],
      N = '//g.alicdn.com',
      V = '//g-assets.daily.taobao.net',
      O = '//assets.alicdn.com/g',
      G = '//s.alicdn.com/@g/',
      L = '//u.alicdn.com',
    ...
    e.run = l.extend({
      ...
      getParam: function (t) {
        ...
        var a = e.getParam ? 'WindVane' : o,
          ...
          i =
            (goldlog.spm_ab ? goldlog.spm_ab.join('.') : '0.0',
            'sid=' + t + '@valueIsEmpty=' + !r);
      ...
      _$: {
        _sendPV: function (t, e) {
          ...
          return (
            'undefined' == typeof t.recordType &&
              (t.recordType = j.recordTypes.pv),
            a.run(t, e, { fn_after_pv: M }),
            !0
          );
        },
        _sendPseudo: function (t, e) {
          ...
          return (
            'undefined' == typeof t.recordType &&
              (t.recordType = j.recordTypes.prepv),
            a.run(t, e, {}, function () {
      ...
      record: function (t, e, n, o, a) {
        if (
          ...
          return (
            ...
            S.run(
              { recordType: j.recordTypes.hjlj, method: o },
      ...
      setMetaInfo: function (t, e, n) {
        if (x.setMetaInfo(t, e, n)) {
          var o = m.getGoldlogVal('_$') || {};
          o.meta_info = x.qGet();
          var a = m.setGoldlogVal('_$', o),
            r = k.isDisablePvid() + '';
          return (
            'aplus-disable-pvid' === t && r !== e + '' && w.resetSpmCntPvid(),
      ...
      appendMetaInfo: x.appendMetaInfo,
            ...
            if (e.match && e.match(/^[\w\-\*]+\.[\w\-\*\/]+\.[\w\-\*\/]+$/)) {
              for (
                var w = 'data-auto-spmd-max-idx',
                  x = 'data-spm-max-idx',
                  T = i ? w : x,
                  j = parseInt(v.tryToGetAttribute(t, T)) || 0,
                  S = 0;
                S < g.length;
                S++
              ) {
  ...
  function (t, e, n) {
    ...
    e.initGoldlog = function (t) {
      var e = window.goldlog || (window.goldlog = {}),
        n = s.goldlog_path.run.create();
      e._ready_time = new Date().getTime();
      for (var u in n) e[u] = n[u];
      var p = /TB\-PD/i.test(navigator.userAgent),
        g = (e._$ = e._$ || {});
      return (
        (g.meta_info = c),
        (g.is_terminal =
          'aplus_wap' === s.script_name || p || '1' == c['aplus-terminal']),
        (g.send_pv_count = 0),
        (g.status = l),
        (g.script_name = s.script_name),
        (g.spm = { data: {} }),
        (g.page_referrer = o.getRefer()),
        (g.pageLoadTime = new Date().getTime()),
        (e.lver = s.lver),
        (e.nameStorage = a.nameStorage),
        i.haveNativeFlagInUA(),
        r.doPubMsg(['goldlogReady', l]),
        r.doCachePubs(['goldlogReady', l]),
        t.init(),
        e
      );
    };
